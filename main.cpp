...
int main(int arg, char *argv[])
{
    ...
    ofstream outdata;
    outdata.open("C:/Users/adamk/OneDrive/Plocha/Extended essay/memoization.txt");
    outdata.close();
    
    outdata.open("C:/Users/adamk/OneDrive/Plocha/Extended essay/memoization.txt", ios::app);
